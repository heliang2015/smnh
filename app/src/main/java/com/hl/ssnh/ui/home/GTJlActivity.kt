...
class GTJlActivity : AppCompatActivity() {
    ...
    var content =
            "➼ 1.不信消息面，一切言论，一切尽在股价中反应。（不看雪球，不停大V吹票，不用太悲观，也不用太乐观）牢记牢记股票市场就是一个战场，是一场博弈，是去抢别人口袋里面的钱，各种尔虞我诈下套，你知道的利好，机构早已知道，你知道的利空，机构也早已知道。机构就是想方设法把你口袋里面的钱抢走，所以要有纪律，只有记录才能保证你克服人性大概率的赚钱" +
            ...
            "➼ 5.不要贪心，要有耐心，总想着每天能涨3，4个点，一周能赚个20多个点，一只固定股票一年操作固定的仓位20个点就足以了；你就是大牛了；\n\n" +
            ...
            "➼ 9.早上不看盘，不盯盘，不盯盘，不盯盘，只在下午2.40操盘。\n\n"+

            "➼ 10.股票操作的机会很多，很多，不要觉得错过了这一次就错过了好几万似的，已经错过就让他过去。\n\n"+

            "➼ 11.不要着急心浮气躁，先慢慢练习，提高胜率，做到大胜率在大仓位！。\n\n"
