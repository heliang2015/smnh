...
//    </style>
     ...
     * 設置Helvetica字體
     */
    public static void setTextViewFontToHelvetica(Context context,TextView textView){
        try{
            Typeface fromAsset = Typeface.createFromAsset(context.getAssets(), "fonts/HelveticaNeue.ttf");
            textView.setTypeface(fromAsset);
        }catch (Exception e){
            e.printStackTrace();
        }
